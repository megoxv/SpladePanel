    ...
    <tr>
        ...
        @foreach($table->columns() as $column)
            <th
                ...
                class="@if($loop->first && $hasBulkActions) pr-6 @else px-6 @endif py-3 text-left text-xs font-medium tracking-wide text-gray-500 dark:text-gray-300 {{ $column->classes }}"
            >
                @if($column->sortable)

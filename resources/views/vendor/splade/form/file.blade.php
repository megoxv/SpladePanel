...
>
    <template #default="{!! $scope !!}">
        <label class="block">
            ...
            @else
                <a @submit.prevent
                    class="inline-block py-2 px-3 rounded-md border border-gray-300 shadow-sm bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 relative cursor-pointer font-medium text-gray-700 dark:text-gray-300 text-sm focus:outline-none focus:ring focus:ring-opacity-50 focus:border-indigo-300 focus:ring-indigo-200 text-center">

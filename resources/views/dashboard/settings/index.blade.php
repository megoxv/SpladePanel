    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-4 bg-white rounded-lg">
            <div class="flex justify-between mb-4">
                <h1 class="text-2xl font-semibold">@lang('main.settings')</h1>
            </div>
            <div>
                <x-splade-form :action="route('dashboard.settings.update')" method="PUT" class="space-y-4"
                    ...
                    {{-- SEO Configuration  --}}
                    <h2 class="text-2xl font-semibold">@lang('main.seo_configuration')</h2>
                    ...
                    {{-- Logo & Favicon  --}}
                    <h2 class="text-2xl font-semibold">@lang('main.logo_and_favicon')</h2>
                    ...
                    {{-- SMTP --}}
                    <h2 class="text-2xl font-semibold">@lang('main.smtp')</h2>
                    ...
                    {{-- Custom Code --}}
                    <h2 class="text-2xl font-semibold">@lang('main.custom_code')</h2>
